...
var CompositeCalendar = function (_Component) {
    _inherits(CompositeCalendar, _Component);
    ...
    function CompositeCalendar(props) {
        ...
        _this.state = {
            ...
            selected_from_date: props.from ? (0, _Date.toMoment)(props.from) : null,
    ...
    _createClass(CompositeCalendar, [{
        ...
        value: function selectDateRange(from) {
            ...
            this.setState({
                selected_from_date: from ? (0, _Date.toMoment)().startOf('day').subtract(from, 'day').unix() : null,
        ...
        value: function render() {
            ...
            return (
                ...
                _react2.default.createElement(
                    ...
                    null,
                    _react2.default.createElement(_inputField2.default, { icon: _iconCalendar2.default, onClick: this.showCalendar.bind(this, 'from'), value: this.from_date_label }),
                    _react2.default.createElement(_inputField2.default, { icon: _iconCalendar2.default, onClick: this.showCalendar.bind(this, 'to'), value: this.to_date_label }),
        ...
        get: function get() {
            ...
            return !this.state.selected_from_date ? (0, _localize.localize)('From the start') : date.format('MMM, DD YYYY');
        }
    }]);
...
var TwoMonthPicker = function (_Component) {
    _inherits(TwoMonthPicker, _Component);
    ...
    _createClass(TwoMonthPicker, [{
        ...
        value: function validateToArrows(date, range) {
            ...
            var r_date = (0, _Date.epochToMoment)(this.state.right_pane_date);
            if ((0, _Date.diffInMonths)((0, _Date.toMoment)(), r_date) === 0) return true;
        ...
        value: function navigateTo(e) {
            this.setState({
                left_pane_date: (0, _Date.subMonths)(e, 1),
                right_pane_date: e
            });
        }
    }, {
...
var _compositeCalendar = __webpack_require__(/*! ../../../App/Components/Form/CompositeCalendar/composite-calendar.jsx */ "./src/javascript/app/App/Components/Form/CompositeCalendar/composite-calendar.jsx");
...
var _marketUnderlying = __webpack_require__(/*! ../Helpers/market-underlying */ "./src/javascript/app/Modules/Reports/Helpers/market-underlying.js");
    ...
    function Statement() {
        ...
        return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = Statement.__proto__ || Object.getPrototypeOf(Statement)).call.apply(_ref, [this].concat(args))), _this), _this.getRowAction = function (row_obj) {
            ...
            if (row_obj.id && ['buy', 'sell'].includes(row_obj.action_type)) {
                action = (0, _Constants.getSupportedContracts)()[(0, _marketUnderlying.getMarketInformation)(row_obj.shortcode).category.toUpperCase()] ? (0, _helpers.getContractPath)(row_obj.id) : {
