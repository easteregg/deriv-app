...
var CompositeCalendar = function (_React$PureComponent) {
    ...
    function CompositeCalendar(props) {
        ...
        var date = (0, _Date.toMoment)(props.to).endOf('day');
...
var TwoMonthPicker = function (_Component) {
    ...
    _createClass(TwoMonthPicker, [{
        ...
        value: function updateSelectedDate(which, e) {
            var new_value = _moment2.default.utc(e.target.dataset.date, 'YYYY-MM-DD');

            this.props.onChange(which === 'to' ? new_value.endOf('day').unix() : new_value.startOf('day').unix());
        }
    }, {
        key: 'render',
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(_calendarBody2.default, {
                        ...
                        hide_others: true,
                        updateSelected: this.updateSelectedDate.bind(this, 'from')
                    })
                ),
                _react2.default.createElement(
                    'div',
                    ...
                    _react2.default.createElement(_calendarBody2.default, {
                        ...
                        isPeriodDisabled: this.shouldDisableDate.bind(this),
                        hide_others: true,
                        updateSelected: this.updateSelectedDate.bind(this, 'to')
                    })
                )
            );
        }
