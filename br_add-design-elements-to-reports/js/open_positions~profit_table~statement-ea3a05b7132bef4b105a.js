...
var MarketSymbolIconRow = function MarketSymbolIconRow(_ref) {
    ...
    var market_information = (0, _marketUnderlying.getMarketInformation)(payload.shortcode);
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    _Popover.Popover,
                    {
                        ...
                        alignment: 'top',
                        message: (0, _marketUnderlying.getMarketName)(market_information.underlying),
            ...
            _react2.default.createElement(
                ...
                _react2.default.createElement(
                    _Popover.Popover,
                    {
                        ...
                        alignment: 'top',
                        message: (0, _marketUnderlying.getTradeTypeName)(market_information.category),
                        disable_target_icon: true
                    },
...
var getOpenPositionsColumnsTemplate = exports.getOpenPositionsColumnsTemplate = function getOpenPositionsColumnsTemplate(currency) {
    return [{
        ...
        renderCellContent: function renderCellContent(_ref13) {
            ...
            return _react2.default.createElement(_indicativeCell2.default, { amount: +cell_value, currency: currency, status: !row_obj.is_valid_to_sell ? 'no-resale' : '' });
        }
    }, {
